...
const Hero = () => {
  return (
    <div className="flex justify-between flex-wrap md:flex-nowrap mb-20">
      <div className="h-screen w-full hero-bg md:flex-[50%] flex flex-col mb-16">
        <div className="flex flex-col justify-center text-center md:text-left flex-1 px-primary">
          ...
          <p className="text-lg lg:text-[22px] mb-[85px]">
            The Easiest Way to Boost Your Employability and Secure Global
            Opportunities
          </p>
          <GetStartedButton />
        </div>
      </div>
      <div className="py-[50px] px-12 bg-primary md:flex-[50%] w-full lg:h-full xl:h-[calc(100vh-114px)] rounded-lg flex flex-col">
        <Image
          src={HomeImage}
          alt="JAPA"
        ...
        <Link href="/#testimonial">
          <div className="flex items-center gap-[22px] relative px-[15px] py-[10px] rounded-[10px] bg-white mt-[27px] flex-wrap lg:flex-nowrap">
            <Image
              ...
              className="w-[100px]"
            />
            <span className="text-[#000000CC] lg:text-[21px]">
