...
const RegisterForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      mySelect: yup.string().required("gender is required"),
    }),
  ...
  return (
    <>
      <h1 className="font-semibold text-2xl md:text-[32px] mb-1">
        Create an account
      </h1>
      <div className="mb-10 text-[#828282] font-medium">
        Let&apos;s get started
      </div>
      <form onSubmit={formik.handleSubmit} className="w-full ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <LabelSelect name="age" formik={formik} label="Age">
            ...
            <option value="3">51 and above </option>
          </LabelSelect>
        </div>
